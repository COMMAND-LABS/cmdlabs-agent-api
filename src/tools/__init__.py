...
from .send_template_email_with_ses import create_send_template_email_with_ses_tool
...
ToolRegistry.register("sendTemplateEmailWithSes", create_send_template_email_with_ses_tool)
